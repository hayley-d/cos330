...
const IMAGE_PERMISSIONS = new Set<Permission>([
  "create_image",
  "view_image",
  "update_image",
  "delete_image",
...
const DOCUMENT_PERMISSIONS = new Set<Permission>([
  "create_doc",
  "view_doc",
  "update_doc",
  "delete_doc",
...
const CONFIDENTIAL_PERMISSIONS = new Set<Permission>([
  "create_conf",
  "view_conf",
  "update_conf",
  "delete_conf",
...
function allowedSetFor(resource: Resource): Set<Permission> {
  switch (resource) {
    ...
    case "confidential":
      return CONFIDENTIAL_PERMISSIONS;
  }
}
